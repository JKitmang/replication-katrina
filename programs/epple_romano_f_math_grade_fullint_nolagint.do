*===============================================================================
* FILE:     epple_romano_f_math_grade_fullint_nolagint.do
* PROJECT:  Katrina's Children (Imberman, Kugler & Sacerdote, AER)
* ROLE:     Robustness/variant (Epple-Romano test, MATH, "lag not interacted")
* PRODUCES: "Lag not interacted" robustness rows of the Epple-Romano linear-in-
*           means results (Table 6 / Appendix Table 14, math) -- middle/high only.
*
* PURPOSE:  Robustness variant of epple_romano_f_math_grade_fullintb.do. Same
*           Epple-Romano construction (peer MEAN achievement by own quartile,
...
*           quartile (the `xi i.mathQUART*math_lag_*` step present in the main file
*           is omitted here). The elementary block and the "no lag" rows are dropped.
*
...
* ===========================================================================
* ---- EPPLE-ROMANO TEST CONSTRUCTION (MATH, "lag not interacted" variant) ----
...
* 2SLS w/ lag controls NOT interacted (lag-not-interacted variant, mid/high math) -> Table 6 / App 14
*MIDHIGH W/LAG
