*===============================================================================
* FILE:     epple_romano_f_math_grade_fullintb_nolag.do
* PROJECT:  Katrina's Children (Imberman, Kugler & Sacerdote, AER)
* ROLE:     Robustness/variant (Epple-Romano linear-in-means test, MATH, "no lag")
* PRODUCES: "No lag" robustness rows of the Epple-Romano linear-in-means results
*           (Table 6 / Appendix Table 14, math) -- the variant that does NOT
...
*           instrumented by evacuee CONTRIBUTION to the lagged peer mean), but in
*           the middle/high block the lagged scores are entered un-interacted with
*           the own quartile (note the demean/center list adds the un-interacted
*           lag terms and the `xi i.quartile*lag` interaction step is dropped).
*           NOTE: this file appears to have been produced by a mechanical find-and-
*           replace of ela->math on the *_ela_* version; several lines are
*           therefore duplicated and some refer to math twice. Documentation only;
*           no code is altered.
*
...
* baseline achievement quartiles within grade-year (built from *0005 composite score)
...
replace math_lag=math0005 if year>2005   // YEAR HARDCODE
...
* recall that lag is constrained to be 2004 or earlier
replace math_lagyear=min(math_lagyear, 2004)   // YEAR HARDCODE: cap lag year at 2004
replace math_lagyear=. if math_lagyear2==.
...
* ===========================================================================
* ---- EPPLE-ROMANO LINEAR-IN-MEANS TEST CONSTRUCTION (MATH, "no lag" variant) ----
...
* ===========================================================================
* ---- ELEMENTARY (grade<=5): OLS / reduced form / 2SLS (math, no-lag variant) ----
* ===========================================================================
***ELEM***
...
* 2SLS w/ un-interacted lag controls (no-lag variant, mid/high math) -> Table 6 / App Table 14
*MIDHIGH W/LAG
